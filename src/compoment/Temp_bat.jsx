...
const Temp_bat = ({ value = 90, max = 150, size = 150, thickness = 7, color = '#08ff00' }) => {
    ...
    return (
        <Box
            ...
            left='78%' // ปรับตำแหน่งจากด้านซ้าย
        ...
        >
            ...
            <LiaTemperatureHighSolid
                style={{
                    ...
                    fontSize: `${size * 0.2}px`, // ขนาดของไอคอน
                    color: '#ffffff',
